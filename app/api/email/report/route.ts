...
export async function POST(request: NextRequest) {
  try {
    ...
    const assessmentData: AssessmentData = {
      ...
      scoreInbound: assessment.scoreInbound || 0,
      scoreOutbound: assessment.scoreOutbound || 0,
      scoreContent: assessment.scoreContent || 0,
      scorePaid: assessment.scorePaid || 0,
      scoreNurture: assessment.scoreNurture || 0,
      scoreInfra: assessment.scoreInfra || 0,
      scoreAttribution: assessment.scoreAttribution || 0,
